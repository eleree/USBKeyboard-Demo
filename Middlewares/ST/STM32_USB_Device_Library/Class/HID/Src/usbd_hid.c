...
#define KEYBOARD_SIZ_STRING_VENDOR             22	   
#define KEYBOARD_SIZ_STRING_PRODUCT            16	   
...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgDesc[KEYBOARD_SIZ_CONFIG_DESC]  __ALIGN_END =
{
...
/* USB HID device Configuration Descriptor */
__ALIGN_BEGIN static uint8_t USBD_HID_Desc[KEYBOARD_SIZ_DEVICE_DESC]  __ALIGN_END  =
{
  /* 18 */
  0x09,         /*bLength: HID Descriptor size*/
  USB_DEVICE_DESCRIPTOR_TYPE, /*bDescriptorType: HID*/
...
__ALIGN_BEGIN static uint8_t USBD_HID_DeviceQualifierDesc[KEYBOARD_SIZ_DEVICE_DESC]  __ALIGN_END =
{
  0x12,
...
__ALIGN_BEGIN static uint8_t HID_MOUSE_ReportDesc[KEYBOARD_SIZ_REPORT_DESC]  __ALIGN_END =
{
  0x05,   0x01,
  0x09,   0x06,
  0xA1,   0x01,
